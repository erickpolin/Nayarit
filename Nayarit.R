...
attach(ConcNayarit) #this is for not writing the name of the data frame and the $ ever time

#Sort Conc according to INGCOR, FOLIOVIV, FOLIOHOG
ConcNayarit<- orderBy (~+ing_cor+folioviv+foliohog, data=ConcNayarit) #this give us the households sorted by total income

#Adding the values of the expansion FACTOR. The sum is 34 million, which is the number of households in the country.
tot_hogares<-sum(ConcNayarit$factor,to.data.frame=TRUE)
...
ConcNayarit$tam_dec<-tam_dec

# Creating Deciles of Income 

ConcNayarit$MAXT<-ConcNayarit$ing_cor #vamos a crear en esta base la variable MAXT que es una copia de la columna de ingresos

ConcNayarit<-ConcNayarit[with(ConcNayarit, order(rank(MAXT))),]  #lo que hicimos aqu? fue reordenar la base con respecto a MAXT. Cosa que en realidad, ya estaba.

ConcNayarit$ACUMULA<-cumsum(ConcNayarit$factor) #aqu? creamos una variable de suma acumulada del FACTOR de viviendas.
...
for(i in 1:9)
{
  a1<-ConcNayarit[dim(ConcNayarit[ConcNayarit$ACUMULA<tam_dec*i,])[1]+1,]$factor
  ConcNayarit<-rbind(ConcNayarit[1:(dim(ConcNayarit[ConcNayarit$ACUMULA<tam_dec*i,])[1]+1),],
                             ConcNayarit[(dim(ConcNayarit[ConcNayarit$ACUMULA<tam_dec*i,])[1]+1):dim(ConcNayarit[1])[1],])
  
  b1<-tam_dec*i-ConcNayarit[dim(ConcNayarit[ConcNayarit$ACUMULA<tam_dec*i,])[1],]$ACUMULA
  ConcNayarit[(dim(ConcNayarit[ConcNayarit$ACUMULA<tam_dec*i,])[1]+1),]$factor<-b1
  ConcNayarit[(dim(ConcNayarit[ConcNayarit$ACUMULA<tam_dec*i,])[1]+2),]$factor<-(a1-b1)
}

#aqu? estamos creando otra variable de suma acumulada del n?mero de hogares
ConcNayarit$ACUMULA2<-cumsum(ConcNayarit$factor)
...
ConcNayarit[(ConcNayarit$ACUMULA2<=tam_dec),]$DECIL<-1
...
for(i in 1:9)
{
  ConcNayarit[((ConcNayarit$ACUMULA2>tam_dec*i)&(ConcNayarit$ACUMULA2<=tam_dec*(i+1))),]$DECIL<-(i+1)
}

# a lo que le qued? cero (que es la ?ltima observaci?n), ponle el decil 10
ConcNayarit[ConcNayarit$DECIL%in%"0",]$DECIL<-10

setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Nayarit")
write.dbf(ConcNayarit,file="ConcNayarit2010.dbf")
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Nayarit")
write.dbf(ConcNayarit,file="ConcNayarit2018.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Nayarit")
Conc2010<-read.dbf("ConcNayarit2010.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Nayarit por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Nayarit por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Nayarit por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Nayarit por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Nayarit por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Nayarit INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Nayarit INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Nayarit INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Nayarit INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Nayarit INDIGENA por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Nayarit NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Nayarit NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Nayarit NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Nayarit NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Nayarit NO por fuente por DECIL LS 2010.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Nayarit")
Conc2018<-read.dbf("ConcNayarit2018.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Nayarit Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Nayarit Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Nayarit Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Nayarit Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Nayarit Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Nayarit INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Nayarit INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Nayarit INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Nayarit INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Nayarit INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Nayarit NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Nayarit NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Nayarit NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Nayarit NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Nayarit NO Ingresos por fuente por DECIL LS 2018.dbf")
...
Deciles2010<-read.dbf("Nayarit por fuente por DECIL estimaciones 2010.dbf")
names(Deciles2010)[1]<-c("ingcor2010")

Deciles2018<-read.dbf("Nayarit Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010No<-read.dbf("Nayarit NO por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010No)[1]<-c("No2010")

deciles2018No<-read.dbf("Nayarit NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010indigena<-read.dbf("Nayarit INDIGENA por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010indigena)[1]<-c("Indigena2010")

deciles2018indigena<-read.dbf("Nayarit INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
